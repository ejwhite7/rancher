// @ts-nocheck
/* Attributor 2.1.1, commit 219bd77bc04cb8fe0bf28d9896e7c2963203f5d5
 * Copyright (c) 2020 Derek Cavaliero — MIT License
 * Locally vendored with Rancher cookie-security and constructor hardening.
 */
...
Attributor.prototype = {
  ...
  setCookie: function(name, value, expires, units) {
    ...
    document.cookie = name + '=' + encodeURIComponent(JSON.stringify(value)) + ((expires == null) ? '' : (this.config.cookieDomain ? '; domain=.' + this.config.cookieDomain : '') + '; expires=' + expireDate.toUTCString()) + '; path=/; SameSite=Lax' + (location.protocol === 'https:' ? '; Secure' : '');
